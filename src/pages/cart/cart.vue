...
const authorityStatus = memberStore.authorityStatus
</script>

<template>
  <scroll-view scroll-y class="scroll-view">
    <!-- 已登录: 显示购物车 -->
    <!--    <template v-if="userInfo && authorityStatus === 2">-->
    <template>
      <!-- 购物车列表 -->
    ...
    <!-- 未登录: 提示登录 -->
    <!--    <view class="login-blank" v-if="!userInfo">-->
    <!--      <text class="text">登录认证后可查看购物车中的商品</text>-->
    <!--      <navigator url="/pages/login/login" hover-class="none">-->
    <!--        <button class="button">去登录</button>-->
    <!--      </navigator>-->
    <!--    </view>-->
    <!--    <view class="login-blank" v-if="userInfo && authorityStatus !== 2">-->
    <!--      <text class="text">认证后可查看购物车中的商品</text>-->
    <!--      <navigator url="/pages/login/login" hover-class="none">-->
    <!--        <button class="button">去认证</button>-->
    <!--      </navigator>-->
    <!--    </view>-->
    <!-- 底部占位空盒子 -->
